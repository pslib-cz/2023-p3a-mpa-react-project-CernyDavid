...
const enemies: Enemy[] = [
    {name: "Kishilian", level: 10, description: "Kishilians are a sentient carnivorous race inhabiting the planet Kishili and its two moons, Lish I and Lish II.", hp: 1000, dmg: 100, imgUrl: "enemy1.jpg"},
    {name: "Waccan", level: 20, description: "Waccans are semi-sentient nocturnal reptilian creatures of unknown origins. They can be found in most parts of the galaxy.", hp: 2000, dmg: 200, imgUrl: "enemy2.jpg"},
    {name: "M'Tak Warrior", level: 30, description: "The M'Tak are a highly-intelligent species from the planet Inui, most of which are powerful warriors. Contary to popular beliefs, they are actually not insect nor insectoids, but mammals.", hp: 4000, dmg: 400, imgUrl: "enemy3.jpg"},
    {name: "Zanzik", level: 40, description: "Zanziks are an amphibian sentient race originating from the planet Zanzi. Many Zanziks are working either as mercenaries or bounty hunters and they are widely recognized as one of the most dangerous species in the entire galaxy.", hp: 8000, dmg: 800, imgUrl: "enemy4.jpeg"},
    {name: "Natarra the Planet Eater", level: 100, description: "Your last words: \"I thought he'd be... bigger.\"", hp: 10000000000, dmg: 2000, imgUrl: "enemy5.jpg"}
];
