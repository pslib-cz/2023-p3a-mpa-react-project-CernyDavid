        ...
        <div className={"base"}>
            ...
            <div className={"base__main"}>
                <div className={"building"} onClick={() => setShowMainframeMenu(true)}>
                    ...
                    <img draggable="false" src="./imgs/mainframe.png" className={"building__image"} />
                </div>
                <div className={showMainframeMenu ? "building-menu building-menu--visible" : "building-menu"} onClick={() => setShowMainframeMenu(false)}>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>{1000 * Math.pow(2, state.mainframeLevel)} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {500 * Math.pow(2, state.mainframeLevel)} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                            {200 * Math.pow(2, state.mainframeLevel)} <img draggable="false" src="./imgs/gemstone.png" className={"cost-icon"} />
                        </p>
                ...
                <div className={"building"} onClick={() => setShowFactoryMenu(true)}>
                    ...
                    <img draggable="false" src="./imgs/factory.png" className={"building__image"} />
                </div>
                <div className={showFactoryMenu ? "building-menu building-menu--visible" : "building-menu"} onClick={() => setShowFactoryMenu(false)}>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>{100 * Math.pow(5, state.factoryLevel)} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {20 * Math.pow(5, state.factoryLevel)} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                        </p>
                ...
                <div className={"building"} onClick={() => setShowArmoryMenu(true)}>
                    ...
                    <img draggable="false" src="./imgs/armory.png" className={"building__image"} />
                </div>
                <div className={showArmoryMenu ? "building-menu building-menu--visible" : "building-menu"} onClick={() => setShowArmoryMenu(false)}>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>
                            {10000 * Math.pow(2, state.aaibaLevel - 1)} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {5000 * Math.pow(2, state.aaibaLevel - 1)} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                            {2000 * Math.pow(2, state.aaibaLevel - 1)} <img draggable="false" src="./imgs/gemstone.png" className={"cost-icon"} />
                        </p>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>
                            {10000 * Math.pow(2, state.slaughterersLevel - 1)} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {5000 * Math.pow(2, state.slaughterersLevel - 1)} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                            {50000 * Math.pow(2, state.slaughterersLevel - 1)} <img draggable="false" src="./imgs/gemstone.png" className={"cost-icon"} />
                        </p>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>
                            {1000 * Math.pow(5, state.armoryLevel)} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {10 * Math.pow(5, state.armoryLevel)} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                            {2 * Math.pow(5, state.armoryLevel)} <img draggable="false" src="./imgs/gemstone.png" className={"cost-icon"} />
                        </p>
                ...
                <div className={"building"} onClick={() => setShowArdcMenu(true)}>
                    ...
                    <img draggable="false" src="./imgs/ardc.png" className={"building__image"} />
                </div>
                <div className={showArdcMenu ? "building-menu building-menu--visible" : "building-menu"} onClick={() => setShowArdcMenu(false)}>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>
                            {20 * Math.pow(2, state.ardcLevel)} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {50 * Math.pow(2, state.ardcLevel)} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                            {10000 * (state.ardcLevel + 1)} <img draggable="false" src="./imgs/gemstone.png" className={"cost-icon"} />
                        </p>
                ...
                <div className={"building"} onClick={() => setShowBarracksMenu(true)}>
                    ...
                    <img draggable="false" src="./imgs/barracks.png" className={"building__image"} />
                </div>
                <div className={showBarracksMenu ? "building-menu building-menu--visible" : "building-menu"} onClick={() => setShowBarracksMenu(false)}>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>
                            {5000 * state.barracksLevel * state.aaibaLevel} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {1000 * state.barracksLevel * state.aaibaLevel} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                            {1000 * state.barracksLevel * state.aaibaLevel} <img draggable="false" src="./imgs/gemstone.png" className={"cost-icon"} />
                        </p>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>
                            {50000 * state.barracksLevel * state.slaughterersLevel} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {50000 * state.barracksLevel * state.slaughterersLevel} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                            {100000 * state.barracksLevel * state.slaughterersLevel} <img draggable="false" src="./imgs/gemstone.png" className={"cost-icon"} />
                        </p>
                    ...
                    <div>
                        ...
                        <p className={"building-menu__cost"}>
                            {50 * Math.pow(5, state.barracksLevel)} <img draggable="false" src="./imgs/metal.png" className={"cost-icon"} />
                            {50 * Math.pow(5, state.barracksLevel)} <img draggable="false" src="./imgs/crystal.png" className={"cost-icon"} />
                            {50 * Math.pow(5, state.barracksLevel)} <img draggable="false" src="./imgs/gemstone.png" className={"cost-icon"} />
                        </p>
